...
function pesapal_config() {
    ...
    $configarray = array(
        "FriendlyName" => array("Type" => "System", "Value" => "Pesapal ( Visa, MasterCard, American Express, Mpesa, etc. )"),
        "adminuser" => array("FriendlyName" => "WHMCS Admin username", "Type" => "text", "Size" => "50", "Default" => "admin"),
        ...
        "consumerkey" => array("FriendlyName" => "Consumer Key", "Type" => "text", "Size" => "50", "Default" => '5Ph0wvuY9klx+hYxtRMPeqVZuBG+f7Mu'),
        "consumersecret" => array("FriendlyName" => "Consumer Secret", "Type" => "text", "Size" => "50", "Default" => 'wA19gaaElqEGzHtw67bc9XXWoGU='),
        ...
        "basedomainurl" => array("FriendlyName" => "Base Domain", "Type" => "text", "Size" => "100", "Description" => "Base Domain URL e.g " . $systemurl,"Default" => $systemurl),
    );
